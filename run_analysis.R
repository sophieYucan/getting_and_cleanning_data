...
### 1. merge test set and train set  #################################################¡ª#
...
### 4.get activity namesget activity names############################################¡ª#
...
### 5.create data set contails:subject,activitylabel,mean of other variables########¡ª#
